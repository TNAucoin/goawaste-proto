...
go mod init github.com/tnaucoin/goawaste-proto/golang/${SERVICE_NAME} || true
go mod tidy
cd ../../

git config --global user.email "travisdevaucoin@gmail.com"
git config --global user.name "Travis Aucoin"
